...
# Load model
model = pickle.load(open(r'C:\Users\lenovo\OneDrive\Documents\Heart disease prediction\rf_classifier.pkl', 'rb'))
scaler = pickle.load(open(r'C:\Users\lenovo\OneDrive\Documents\Heart disease prediction\scaler.pkl', 'rb'))
